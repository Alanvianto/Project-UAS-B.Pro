...
public class AreaAdmin 
{
			...
			switch (Pil_Buah) 
			{
				...
				case 1:
					do 
					{
						...
						System.out.println ("5. Mencari Data Buah");
						...
						int urutan=-1;
							...
							if (pilbuah == 3)
							{
								...
								if (id.contains(gantiID.toUpperCase()))
								{
									...
									if (GantiID.equalsIgnoreCase("y"))
									{
										...
										hargabeli.setElementAt(HARGA2, urutan);
										//Menentukan harga jual
										int hj2 = (HARGA2*10/100);
										hargajual.setElementAt((HARGA2+hj2), urutan);
									}
									else 
									{
							...
							if (pilbuah == 4)
							{
								System.out.println("ID Buah\t Nama Buah\t Harga Beli\t Harga Jual");
							...
							if (pilbuah == 5)
							{
								System.out.print ("\n");
									...
									for (int i=0; i<id.size(); i++)
									{
										if (namabuah.elementAt(i).equalsIgnoreCase(nb))
										{
											System.out.println (id.elementAt(i)+"\t"+namabuah.elementAt(i)+"\t"+hargabeli.elementAt(i)+"\t"+hargajual.elementAt(i));
										}
	...
	public static Vector <String> minggu = new Vector <String>();
